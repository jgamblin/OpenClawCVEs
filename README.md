...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/GHSA_CVEs-55-orange?style=for-the-badge" alt="Project CVEs Assigned">
  <img src="https://img.shields.io/badge/published-55-brightgreen?style=for-the-badge" alt="CVEs Published">
  ...
  <img src="https://img.shields.io/badge/awaiting_CVE-102-lightgrey?style=flat-square" alt="Awaiting CVE">
</p>
...
<p align="center">
  <sub>Last updated: 2026-08-25 18:43 UTC · <a href="LICENSE">MIT License</a> · <a href="ADVISORIES.md">Full Advisory List</a> · <a href="SECURITY.md">Security Policy</a> · Data: <a href="https://github.com/CVEProject/cvelistV5">cvelistV5</a> + <a href="https://github.com/github/advisory-database">Advisory DB</a> · Updates every 6h</sub>
</p>
...
<p align="center">
  ...
  <a href="#-cves-published-in-cvelistv5-55">Published CVEs</a> ·
...
## 🚀 CVEs Published in cvelistV5 (55)
...
Of 55 GHSAs with CVE IDs, **55** are fully published and **0** remain `RESERVED`.
...
| Insight | Detail |
|---------|--------|
| **Dominant Weakness** | 61% of categorized issues relate to **Allowlist Bypass** (39/64) |
| **V5 Sync Rate** | 55/55 CVE IDs (100%) have full cvelistV5 records |
...
|----------|------:|----------|
| **OS Command Injection (CWE-78)** | 11 | PATH injection, SSH command injection, Docker exec, keychain writes |
...
| [GHSA-gwcq-453v-2frr](https://github.com/advisories/GHSA-gwcq-453v-2frr) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | Duplicate Advisory: OpenClaw's POSIX node system.run safe-bin allowlist could be widened by shell expansion | 2026-06-13 |
...
| [GHSA-p68j-q8j9-jwf5](https://github.com/advisories/GHSA-p68j-q8j9-jwf5) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | Duplicate Advisory: OpenClaw: Slack and Zalo webhook secrets could remain active after secrets.reload | 2026-06-13 |
