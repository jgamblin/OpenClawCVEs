...
<p align="center">
  <img src="https://img.shields.io/badge/advisories-247-red?style=for-the-badge" alt="Total Advisories">
  ...
  <img src="https://img.shields.io/badge/high-82-d63031?style=flat-square" alt="High">
  <img src="https://img.shields.io/badge/medium-136-e17055?style=flat-square" alt="Medium">
  <img src="https://img.shields.io/badge/low-23-27ae60?style=flat-square" alt="Low">
...
<p align="center">
  <sub>Last updated: 2026-03-03 21:16 UTC · <a href="LICENSE">MIT License</a> · <a href="ADVISORIES.md">Full Advisory List</a> · <a href="SECURITY.md">Security Policy</a> · Data: <a href="https://github.com/CVEProject/cvelistV5">cvelistV5</a> + <a href="https://github.com/github/advisory-database">Advisory DB</a> · Updates hourly</sub>
</p>
...
<p align="center">
  ...
  <a href="#-all-security-advisories-247">Advisories</a> ·
...
| Insight | Detail |
|---------|--------|
| **Dominant Weakness** | 42% of categorized issues relate to **Allowlist Bypass** (93/221) |
| **V5 Sync Rate** | 35/40 CVE IDs (88%) have full cvelistV5 records |
| **Advisory Velocity** | 247 security advisories across 2026-02-02 → 2026-03-03 |
| **Top Severity** | 6 Critical + 82 High = 88 high-impact issues (36%) |
...
| **Auth Bypass / Missing Auth** | 22 | WebSocket config.apply, webhook verification, browser relay, sandbox bridge |
...
| [GHSA-f7ww-2725-qvw2](https://github.com/advisories/GHSA-f7ww-2725-qvw2) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw: Node system.run approval bypass via parent-symlink cwd rebind | 2026-03-02 |
| [GHSA-fqcm-97m6-w7rm](https://github.com/advisories/GHSA-fqcm-97m6-w7rm) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw: Message action attachment hydration bypasses local media root checks when sandboxRoot is unset | 2026-03-02 |
| [GHSA-hwpq-rrpf-pgcq](https://github.com/advisories/GHSA-hwpq-rrpf-pgcq) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw: system.run approval identity mismatch could execute a different binary than displayed | 2026-03-02 |
| [GHSA-943q-mwmv-hhvh](https://github.com/advisories/GHSA-943q-mwmv-hhvh) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw: Gateway /tools/invoke tool escalation + ACP permission auto-approval | 2026-03-02 |
| [GHSA-gv46-4xfq-jv58](https://github.com/advisories/GHSA-gv46-4xfq-jv58) | — | ![Critical](https://img.shields.io/badge/CRITICAL-8b0000?style=flat-square) | OpenClaw Vulnerable to Remote Code Execution via Node Invoke Approval Bypass in Gateway | 2026-03-02 |
| [GHSA-xw4p-pw82-hqr7](https://github.com/advisories/GHSA-xw4p-pw82-hqr7) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw's sandbox skill mirroring path traversal vulnerability could write outside the sandbox workspace | 2026-03-02 |
| [GHSA-p25h-9q54-ffvw](https://github.com/advisories/GHSA-p25h-9q54-ffvw) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw has Zip Slip path traversal in tar archive extraction | 2026-03-02 |
| [GHSA-fgvx-58p6-gjwc](https://github.com/advisories/GHSA-fgvx-58p6-gjwc) | — | ![Critical](https://img.shields.io/badge/CRITICAL-8b0000?style=flat-square) | OpenClaw gateway agents.files symlink escape allowed out-of-workspace file read/write | 2026-03-02 |
| [GHSA-mfg5-7q5g-f37j](https://github.com/advisories/GHSA-mfg5-7q5g-f37j) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw voice-call media stream validated streams after upgrade, which could allow pre-start unauthenticated sockets to increase resource pressure | 2026-03-02 |
| [GHSA-jq4x-98m3-ggq6](https://github.com/advisories/GHSA-jq4x-98m3-ggq6) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw Canvas Path Traversal Information Disclosure Vulnerability | 2026-03-02 |
| [GHSA-5v6x-rfc3-7qfr](https://github.com/advisories/GHSA-5v6x-rfc3-7qfr) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw has Windows system.run approval mismatch on cmd.exe /c trailing arguments | 2026-03-02 |
| [GHSA-q399-23r3-hfx4](https://github.com/advisories/GHSA-q399-23r3-hfx4) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw: system.run approvals did not bind PATH-token executable identity, enabling post-approval executable rebind | 2026-03-02 |
| [GHSA-g99v-8hwm-g76g](https://github.com/advisories/GHSA-g99v-8hwm-g76g) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw has web_search citation redirect SSRF via private-network-allowing policy | 2026-03-02 |
| [GHSA-jr6x-2q95-fh2g](https://github.com/advisories/GHSA-jr6x-2q95-fh2g) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw's authorization mismatch allowed write-scope agent runs to reach owner-only tools | 2026-03-02 |
| [GHSA-7xmq-g46g-f8pv](https://github.com/advisories/GHSA-7xmq-g46g-f8pv) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw: Sandbox media TOCTOU could read files outside sandbox root | 2026-03-02 |
| [GHSA-x82f-27x3-q89c](https://github.com/advisories/GHSA-x82f-27x3-q89c) | — | ![High](https://img.shields.io/badge/HIGH-d63031?style=flat-square) | OpenClaw's TOCTOU symlink race in writeFileWithinRoot could create or truncate files outside root boundaries | 2026-03-02 |
| [GHSA-6f6j-wx9w-ff4j](https://github.com/advisories/GHSA-6f6j-wx9w-ff4j) | — | ![Critical](https://img.shields.io/badge/CRITICAL-8b0000?style=flat-square) | CpenClaw's ACPX Windows wrapper shell fallback allowed cwd injection in specific paths | 2026-03-02 |
...
| [GHSA-rx3g-mvc3-qfjf](https://github.com/advisories/GHSA-rx3g-mvc3-qfjf) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw's avatar symlink traversal can expose out-of-workspace local files | 2026-03-03 |
| [GHSA-ww6v-v748-x7g9](https://github.com/advisories/GHSA-ww6v-v748-x7g9) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw has a sandbox network isolation bypass via docker.network=container:<id> | 2026-03-02 |
| [GHSA-v892-hwpg-jwqp](https://github.com/advisories/GHSA-v892-hwpg-jwqp) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw vulnerable to path traversal (Zip Slip) in archive extraction during explicit installation commands | 2026-03-02 |
| [GHSA-jmm5-fvh5-gf4p](https://github.com/advisories/GHSA-jmm5-fvh5-gf4p) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw has non-constant-time token comparison in hooks authentication | 2026-03-02 |
| [GHSA-47q7-97xp-m272](https://github.com/advisories/GHSA-47q7-97xp-m272) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw: Config writes could persist resolved ${VAR} secrets to disk | 2026-03-02 |
| [GHSA-hjvp-qhm6-wrh2](https://github.com/advisories/GHSA-hjvp-qhm6-wrh2) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw Node system.run approval context-binding weakness in approval-enabled host=node flows | 2026-03-02 |
| [GHSA-rxxp-482v-7mrh](https://github.com/advisories/GHSA-rxxp-482v-7mrh) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw's inbound media downloads could exceed configured byte limits before rejection across multiple channels | 2026-03-02 |
| [GHSA-gwqp-86q6-w47g](https://github.com/advisories/GHSA-gwqp-86q6-w47g) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw's exec allow-always can be bypassed via unrecognized multiplexer shell wrappers (busybox/toybox sh -c) | 2026-03-02 |
| [GHSA-6x2m-hqfw-hvpj](https://github.com/advisories/GHSA-6x2m-hqfw-hvpj) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw: Node exec approvals could be replayed across nodes | 2026-03-02 |
| [GHSA-6j27-pc5c-m8w8](https://github.com/advisories/GHSA-6j27-pc5c-m8w8) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw's allow-always wrapper persistence could bypass future approvals and enable command execution | 2026-03-02 |
| [GHSA-36h3-7c54-j27r](https://github.com/advisories/GHSA-36h3-7c54-j27r) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw has browser trace/download path symlink escape in temp output handling | 2026-03-02 |
| [GHSA-c6hr-w26q-c636](https://github.com/advisories/GHSA-c6hr-w26q-c636) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw has ReDoS and regex injection via unescaped Feishu mention metadata in RegExp construction | 2026-03-02 |
| [GHSA-8m9v-xpgf-g99m](https://github.com/advisories/GHSA-8m9v-xpgf-g99m) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw has an unauthorized sender bypass in its stop triggers and /models command authorization | 2026-03-02 |
| [GHSA-p7gr-f84w-hqg5](https://github.com/advisories/GHSA-p7gr-f84w-hqg5) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw's sandboxed sessions_spawn now enforces sandbox inheritance for cross-agent spawns | 2026-03-02 |
| [GHSA-wr6m-jg37-68xh](https://github.com/advisories/GHSA-wr6m-jg37-68xh) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw has unbounded memory growth in Zalo webhook via query-string key churn (unauthenticated DoS) | 2026-03-02 |
| [GHSA-392f-ggf5-fp3c](https://github.com/advisories/GHSA-392f-ggf5-fp3c) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw: Unicode canonicalization drift in node metadata policy classification could broaden node allowlists | 2026-03-02 |
| [GHSA-vpj2-69hf-rppw](https://github.com/advisories/GHSA-vpj2-69hf-rppw) | — | ![Medium](https://img.shields.io/badge/MEDIUM-e17055?style=flat-square) | OpenClaw: Browser control startup could continue unauthenticated after auth bootstrap failure | 2026-03-02 |
...
| GHSA | CVE | Severity | Title | Published |
|------|-----|----------|-------|-----------|
| [GHSA-5ghc-98wh-gwwf](https://github.com/advisories/GHSA-5ghc-98wh-gwwf) | — | ![Low](https://img.shields.io/badge/LOW-fdcb6e?style=flat-square) | OpenClaw's Control UI Static File Handler Follows Symlinks and Allows Out-of-Root File Read | 2026-03-02 |
| [GHSA-5f9p-f3w2-fwch](https://github.com/advisories/GHSA-5f9p-f3w2-fwch) | — | ![Low](https://img.shields.io/badge/LOW-fdcb6e?style=flat-square) | OpenClaw macOS companion app (beta): allowlist parsing mismatch for system.run shell chains | 2026-03-02 |
| [GHSA-wm8r-w8pf-2v6w](https://github.com/advisories/GHSA-wm8r-w8pf-2v6w) | — | ![Low](https://img.shields.io/badge/LOW-fdcb6e?style=flat-square) | OpenClaw has Signal group allowlist authorization bypass via DM pairing-store leakage | 2026-03-02 |
...
### Repo-Only Advisories (~134 more)

These advisories are listed on the [repo security page](https://github.com/openclaw/openclaw/security/advisories) but not yet indexed in the GitHub Advisory Database. See the [full advisory list](ADVISORIES.md) for details.

<details>
<summary><strong>Show 134 repo-only advisories</strong></summary>
