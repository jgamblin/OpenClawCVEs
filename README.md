...
<p align="center">
  <sub>Last updated: 2026-03-19 18:24 UTC · <a href="LICENSE">MIT License</a> · <a href="ADVISORIES.md">Full Advisory List</a> · <a href="SECURITY.md">Security Policy</a> · Data: <a href="https://github.com/CVEProject/cvelistV5">cvelistV5</a> + <a href="https://github.com/github/advisory-database">Advisory DB</a> · Updates hourly</sub>
</p>
...
| Insight | Detail |
|---------|--------|
| **Dominant Weakness** | 52% of categorized issues relate to **Allowlist Bypass** (61/117) |
| **V5 Sync Rate** | 15/15 CVE IDs (100%) have full cvelistV5 records |
| **Advisory Velocity** | 153 security advisories across 2026-02-02 → 2026-03-19 |
| **Top Severity** | 3 Critical + 52 High = 55 high-impact issues (36%) |
...
| **Allowlist Bypass** | 61 | Telegram usernames, Matrix displayName, Slack DM, Twitch, voice-call |
